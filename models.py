...
def egemaps_svm(folder_train = "/home/juanjo/Documentos/eGeMAPS_embedding/egemaps_LA_train_labeled.csv", folder_eval):
    # load data
...
def wav2vec2_svm(train = ["egemaps_LA_train_labeled.csv", "embeddings_LA_train"], eval):
...
def concatenation_svm(train=["egemaps_LA_train_labeled.csv", "embeddings_LA_train"], eval):
...
def late_fusion(train = ["egemaps_LA_train_labeled.csv", "embeddings_LA_train"], eval):
...
def stacking(train=["egemaps_LA_train_labeled.csv", "embeddings_LA_train"], eval):
